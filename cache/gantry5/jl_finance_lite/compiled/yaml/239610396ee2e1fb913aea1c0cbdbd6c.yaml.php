...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jloverlay.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Overlay',
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_overlay' => [
                            ...
                            'fields' => [
                                ...
                                'text_color_hover' => [
                                    ...
                                    'description' => 'Inverse the text color on hover.'
                                ],
                                'overlay_padding' => [
                                    'type' => 'select.select',
                                    'label' => 'Padding',
                        ...
                        '_tab_style' => [
                            ...
                            'fields' => [
                                ...
                                'image_transition' => [
                                    ...
                                    'description' => 'Select an image transition. If the hover image is set, the transition takes place between the two images. If None is selected, the hover image fades in.',
                                    'default' => 'none',
                                    'options' => [
                                ...
                                'meta_color' => [
                                    'type' => 'input.colorpicker',
                                    'label' => 'Custom Color',
                                    'description' => 'Customize the meta color. You need to set the Predefined Color to None before using the color customization.'
                                ],
                                'meta_fontsize' => [
                                    'type' => 'input.number',
                                    'label' => 'Font Size',
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Overlay <strong>Version: 2.2.4</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/overlay-particle-documentation/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
