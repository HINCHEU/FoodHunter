...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlanimatedtext.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Animated Text',
        'description' => 'Applying awesome animations to text.',
        'type' => 'particle',
        'icon' => 'fa-header',
        'form' => [
            'overrideable' => false,
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                ...
                                'animated' => [
                                    ...
                                    'array' => true,
                                    'label' => 'Items',
                                    'description' => 'List text items to animate.',
                                    'value' => 'name',
                                    'ajax' => true,
                                    'fields' => [
                                        '.title' => [
                                            'type' => 'input.text',
                                            'label' => 'Title',
                                            'description' => 'Insert the title text to animate.',
                                ...
                                'after_text' => [
                                    'type' => 'input.text',
                                    'label' => 'After Text',
                                    'description' => 'Customize the after text.',
                                ...
                                'headlines' => [
                                    'type' => 'select.select',
                                    'label' => 'Style',
                                    'description' => 'Choose one of the styles to present your text effect.',
                                    'default' => 'rotate-1',
                                    'overrideable' => false,
                                    'options' => [
                                        'rotate-1' => 'Rotate 1',
                        ...
                        '_tab_style' => [
                            ...
                            'fields' => [
                                ...
                                'title_color' => [
                                    ...
                                    'label' => 'Color',
                                    'description' => 'Customize the headline color.'
                                ],
                                'title_fontsize' => [
                                    'type' => 'input.number',
                                    'label' => 'Font Size',
                                    'min' => 0,
                                    'description' => 'Customize the headline text font size.'
                                ],
                                ...
                                'subtitle_fontsize' => [
                                    ...
                                    'min' => 0,
                                    'description' => 'Customize the Animated Text font size.'
                                ],
                                'sub_text_color' => [
                                    'type' => 'select.select',
                                    'label' => 'Predefined Color',
                                ...
                                'subtitle_color' => [
                                    'type' => 'input.colorpicker',
                                    'label' => 'Text Color',
                                    'description' => 'Customize the Animated Text color.'
                                ]
                            ]
                        ],
                        '_tab_general' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Animated Text <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/animated-text-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
