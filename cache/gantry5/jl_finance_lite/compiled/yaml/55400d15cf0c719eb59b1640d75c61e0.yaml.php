...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlmodulepos.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Module Position',
        'description' => 'Create modal dialogs with different styles and transitions for Joomla modules.',
        'type' => 'particle',
        'icon' => 'fa-joomla',
        'form' => [
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                'title' => [
                                    ...
                                    'description' => 'Customize the Module title.'
                                ],
                                'subtitle' => [
                                    'type' => 'textarea.textarea',
                                    'label' => 'Content Above',
                                    'placeholder' => 'Enter Content',
                                    'description' => 'Customize the content above the module.'
                                ],
                                'info' => [
                                    'type' => 'separator.note',
                                ...
                                'module_id' => [
                                    ...
                                    'description' => 'Pick a Joomla Module.',
                                    'pattern' => '\\d+'
                                ],
                                'description' => [
                                    'type' => 'textarea.textarea',
                                    'label' => 'Content Below',
                                    'placeholder' => 'Enter Content',
                                    'description' => 'Customize the content below the Module Position.'
                                ],
                                'class' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Module Position <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/widget-particle-documentation/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
