...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlopenstreetmap.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Open Street Map',
        'description' => 'Free Map particle, its useful for contact pages, so your visitors can know where you are situated.',
        'type' => 'particle',
        'icon' => 'fa-map',
        'configuration' => [
            'caching' => [
        ...
        'form' => [
            ...
            'fields' => [
                                ...
                                'items' => [
                                    ...
                                    'fields' => [
                                        '.latlong_info' => [
                                            ...
                                            'content' => 'Use the name of a place or address to find <a href="https://www.latlong.net/" target="_blank">lat long coordinates here <i class="fa fa-fw fa-external-link" aria-hidden="true"></i></a>'
                                        ],
                                        '.latitude' => [
                                            'type' => 'input.text',
                                            'label' => 'Latitude',
                                            'description' => 'Enter latitude for maps.',
                                            'placeholder' => 51.5
                                        ],
                                        '.longitude' => [
                                            'type' => 'input.text',
                                            'label' => 'Longitude',
                                            'description' => 'Enter longitude for maps.',
                                            'placeholder' => -0.09
                                        ],
                                        '.pop_content' => [
                                            ...
                                            'placeholder' => 'Customize the popup content.'
                                        ],
                                        '.pop_content_width' => [
                                            'type' => 'input.number',
                                            'label' => 'Popup Width',
                                        ...
                                        '.icon' => [
                                            ...
                                            'label' => 'Custom Icon',
                                            'description' => 'Custom the map icon.'
                                        ],
                                        '.icon_shadow' => [
                                            'type' => 'input.imagepicker',
                                            'label' => 'Custom shadow icon',
                                            'description' => 'Custom the map shadow icon.'
                                        ]
                                    ]
                                ],
                                'map_settings' => [
                        ...
                        '_tab_mapbox' => [
                            ...
                            'fields' => [
                                'token_info' => [
                                    'type' => 'separator.note',
                                    'class' => 'alert alert-info',
                                    'content' => 'Creating <a href="https://www.mapbox.com/studio/account/tokens" target="_blank">access tokens <i class="fa fa-fw fa-external-link" aria-hidden="true"></i></a> with the Tokens API in order to use the MAP style from Mapbox.'
                                ],
                                'accesstoken' => [
                                    'type' => 'input.text',
                                    'label' => 'Access Token',
                                ...
                                'style_info' => [
                                    'type' => 'separator.note',
                                    'class' => 'alert alert-info',
                                    'content' => 'Design your own maps with <a href="https://studio.mapbox.com/" target="_blank">Mapbox Studio <i class="fa fa-fw fa-external-link" aria-hidden="true"></i></a> then add the Style URL below. Learn more about <a href="https://docs.mapbox.com/studio-manual/overview/map-styling/#template-styles" target="_blank">Mapbox Studio Manual <i class="fa fa-fw fa-external-link" aria-hidden="true"></i></a> '
                                ],
                                'mapstyle' => [
                                    'type' => 'input.text',
                                    'label' => 'Style URL',
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Open Street Map <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/open-street-map-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
