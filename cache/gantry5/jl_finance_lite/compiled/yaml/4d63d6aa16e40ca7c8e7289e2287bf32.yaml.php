...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jltext.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Text',
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                ...
                                'dropcap' => [
                                    'type' => 'input.checkbox',
                                    'label' => 'Drop Cap',
                                    'description' => 'Display the first letter of the paragraph as large initial.',
                                    'default' => false
                                ],
                                'text_columns' => [
                                    'type' => 'select.select',
                                ...
                                'column_divider' => [
                                    'type' => 'input.checkbox',
                                    'label' => 'Show Dividers',
                                    'description' => 'Show dividers between the text columns if the Columns is set.',
                                    'default' => false
                                ],
                                'column_breakpoint' => [
                                    'type' => 'select.select',
                                ...
                                'customize_content_color' => [
                                    ...
                                    'label' => 'Custom Color',
                                    'description' => 'Customize the content color instead using predefined text color. <br>Note:You need to set the predefined color to None before using the color customization.'
                                ],
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Text <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/text-particle-documentation/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
