...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlinlinesvg.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Inline Svg',
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                'svg' => [
                                    ...
                                    'label' => 'Svg File',
                                    'description' => 'Add any SVG file such as an icon or artwork and change it’s colour and size.'
                                ],
                                'image_width' => [
                                    'type' => 'input.number',
                                    'label' => 'Width',
                                ...
                                'svg_color' => [
                                    ...
                                    'description' => 'Select the svg color. If the Background option is selected, styles that don\'t apply a background image use the primary color instead.',
                                    'default' => 'default',
                                    'options' => [
                                        'default' => 'None',
                                        'muted' => 'Muted',
                                ...
                                'customize_svg_color' => [
                                    ...
                                    'label' => 'Custom Color',
                                    'description' => 'Customize the color for svg file instead using predefined svg color mode.'
                                ],
                                'class' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Inline Svg <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/inline-svg-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
