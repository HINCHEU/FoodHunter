...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlimagecompare.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Image Compare',
        'description' => 'This particle allows you to display the before and after versions of an image by simply sliding over them.',
        'type' => 'particle',
        'icon' => 'fa-picture-o',
        'form' => [
            'overrideable' => false,
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                ...
                                'label2' => [
                                    'type' => 'input.text',
                                    'label' => 'Title',
                                    'description' => 'Customize the label for second image (Optional).',
                                    'placeholder' => 'After'
                                ],
                                'image2' => [
                                    'type' => 'input.imagepicker',
                                ...
                                'mode' => [
                                    ...
                                    'label' => 'Mode',
                                    'description' => 'Create horizontal or vertical before/after image sliders.',
                                    'default' => 0,
                                    'options' => [
                                        0 => 'Horizontal',
                                        1 => 'Vertical'
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Image Compare <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/image-compare-particle-documentation/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
