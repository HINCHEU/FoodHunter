...
return [
    ...
    'filename' => 'C:\\wamp64\\www\\hincheu/templates/jl_finance_lite/particles/jlquotation.yaml',
    'modified' => 1676022657,
    'data' => [
        'name' => 'JL Quotation',
        ...
        'form' => [
            ...
            'fields' => [
                        ...
                        '_tab_content' => [
                            ...
                            'fields' => [
                                ...
                                'link' => [
                                    'type' => 'input.text',
                                    'label' => 'Author Link',
                                    'description' => 'Specify the author link.',
                                    'placeholder' => 'http://'
                                ],
                                'link_target' => [
                        ...
                        '_tab_style' => [
                            ...
                            'fields' => [
                                ...
                                'author_color' => [
                                    'type' => 'input.colorpicker',
                                    'label' => 'Color',
                                    'description' => 'Customize the author color.'
                                ],
                                'author_fontsize' => [
                                    'type' => 'input.number',
                                    'label' => 'Font Size',
                                    'min' => 0,
                                    'description' => 'Customize the author text font size.'
                                ],
                                'link_style' => [
                                    'type' => 'select.select',
                                    'label' => 'Link Style',
                                ...
                                'footer_color' => [
                                    'type' => 'input.colorpicker',
                                    'label' => 'Color',
                                    'description' => 'Customize the footer color.'
                                ],
                                'footer_fontsize' => [
                                    'type' => 'input.number',
                                    'label' => 'Font Size',
                                    'min' => 0,
                                    'description' => 'Customize the footer font size'
                                ]
                            ]
                        ],
                        '_tab_general' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Quotation <strong>Version: 2.2.3</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/quotation-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
