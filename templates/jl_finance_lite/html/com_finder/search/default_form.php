...
<form action="<?php echo Route::_($this->query->toUri()); ?>" method="get" class="js-finder-searchform">
    ...
    <fieldset class="com-finder__search word jl-fieldset mb-3">
        ...
        <div class="form-inline">
            ...
            <div class="input-group">
                ...
                <button type="submit" class="jl-button jl-button-primary">
                    <span class="icon-search icon-white" aria-hidden="true"></span>
                    <?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>
                </button>
                <?php if ($this->params->get('show_advanced', 1)) : ?>
                    <?php HTMLHelper::_('bootstrap.collapse'); ?>
                    <button class="jl-button jl-button-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#advancedSearch" aria-expanded="<?php echo ($this->params->get('expand_advanced', 0) ? 'true' : 'false'); ?>">
    ...
    <?php if ($this->params->get('show_advanced', 1)) : ?>
        <fieldset id="advancedSearch" class="jl-fieldset com-finder__advanced js-finder-advanced collapse<?php if ($this->params->get('expand_advanced', 0)) {
            echo ' show';
                                                                                             } ?>">
            ...
            <?php if ($this->params->get('show_advanced_tips', 1)) : ?>
                <div class="com-finder__tips jl-card jl-card-default mb-3">
