...
<div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?>">
	<article class="jl-article" itemscope itemtype="https://schema.org/Article" data-permalink="<?php echo Route::_(RouteHelper::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language), true, 0, 1); ?>">
		...
		<div class="page-header">
			<<?php echo $htag; ?> itemprop="headline" class="jl-margin-remove-bottom jl-article-title">
