    ...
    function render($type)
    {
        ...
        if ($paramsfieldSets)
        {
            ...
            foreach ($paramsfieldSets as $name => $fieldSet)
            {
                ...
                $new_open_tab = ['attribs','helix_ultimate_blog_options','articletypeoptions','articleblogoptions','articleogoptions'];
                ...
                $new_close_tab = ['editorConfig','helix_ultimate_blog_options','articletypeoptions','articleblogoptions','articleogoptions'];
