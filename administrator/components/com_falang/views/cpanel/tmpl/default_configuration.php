...
<table class="adminlist table table-striped">
    <tr class="row0">
        <th width="220" align="left"><?php echo JText::_('COM_FALANG_CPANEL_CONFIGURATION_PLG_FALANG'); ?></th>
        <td ><?php
    ...
    <tr class="row1">
        <th width="220" align="left"><?php echo JText::_('COM_FALANG_CPANEL_CONFIGURATION_PLG_LANG_FILTER'); ?></th>
        <td><?php
    ...
    <tr class="row0">
        <th width="220" align="left"><?php echo JText::_('COM_FALANG_CPANEL_CONFIGURATION_PLG_QJUMP'); ?></th>
        <td><?php
